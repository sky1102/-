        ...
        <nav class="navbar " style="height:90px; background-color: #492D18">
         ...
         <div class="mt-5 col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
          <div class="d-flex justify-content-center" >
            ...
            <form class="form-horizontal" action="do_login_cus.php" method="POST" name="form1"　>        
              <div  align="center" style="font-size:25px;color:#aaa;color:#9F714F">《消費者登入》</div>
              ...
              <div class="form-group"> 
                <div class="col-sm-offset-2 col-sm-10">
                  <div class="d-flex justify-content-center">
                    ...
                    <input type="hidden" name="refer" value="<?php echo (isset($_GET['refer'])) ? $_GET['refer'] : 'shop_cus.php'; ?>">
                  </div>
                </div>
              </div>
