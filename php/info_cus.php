...
<body style=" font-family: 微軟正黑體;">
    <div class="row no-gutters">
        ...
        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
            <div class="list-group list-group-flush" style="width:110%; font-size: 18px;">
              ...
              <a href="info_cus.php" class="list-group-item list-group-item-action" style="background-color: #D5B8A3"><i class="fa fa-user-circle" style="font-size:20px"></i>　會員資料</a>
    ...
    <div class="px-5 mt-4 col-xs-10 col-sm-10 col-md-10 col-lg-10">
      ...
      <?php
        ...
        $sql = "SELECT * FROM customer WHERE cus_ID='{$cookie_id}'";  // set up your sql query
        ...
        if ($result->num_rows > 0) {  
          while ( $row = mysqli_fetch_array ( $result ,MYSQLI_ASSOC)) 
          {
             ...
             <div class='frame'>
                <div class='state'>
                  <b>　　姓名：</b>".$row["cus_name"]."</div><br>
                <div class='state'>
                  <b>　　電話：</b>".$row["cus_phone"]."</div><br>
                <div class='state'>
                  <b>電子信箱：</b>".$row["cus_email"]."</div><br>
                <div class='state'>
                  <b>　　密碼：</b>********</div><br>
                <div class='state'>
                  <b>聯絡地址：</b>".$row["cus_address"]."</div><br>
                <div class='state s2'>
              ...
              <div id=show class='frame'>
                <form method='post' action='do_update.php'>
                  <div class='state'>
                    <b>　　姓名：</b><input name='name' style='width:200px' value=".$row["cus_name"].">
                  </div><br>
                  <div class='state'>
                    <b>　　電話：</b><input name='phone' style='width:200px' value=".$row["cus_phone"].">
                  </div><br>
                  <div class='state'>
                    <b>　　帳號：</b><input name='email' style='width:200px' value=".$row["cus_email"].">
                  </div><br>
                  <div class='state'>
                    <b>　　密碼：</b><input name='password' style='width:200px' value=".$row["cus_password"].">
                  </div><br>
                  <div class='state'>
                    <b>聯絡地址：</b><input name='address' style='width:200px' value=".$row["cus_address"].">
                  </div><br>
                  <div class='state s2'>
                  <input type='submit' class='bt btn btn-info' value='確認修改' style='font-size:20px'/>
                  </div>
                </form>
              </div>
            ";
